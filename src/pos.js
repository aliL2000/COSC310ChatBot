...
async function process(sentence) {
    ...
    if (nouns){
        ...
        if (nouns!="ASTARTE"){
            ...
            var url1="https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=bce084b1c055364bbbfa781ee7326a03&tags="+tag+"&per_page=1&page=1&format=json&nojsoncallback=1";
            let urls1 = "";
            $.get(url1, function(data1) {
                ...
                if (obj1.stat=="ok"){
                    ...
                    var farm=temp2.farm;
                    var server=temp2.server;
                    var id=temp2.id;
                    var secret=temp2.secret;
                    urls1 = 'http://farm'+farm+'.staticflickr.com/'+server+'/'+id+'_'+secret+'.jpg';
            ...
            var url2="https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=bce084b1c055364bbbfa781ee7326a03&tags="+tags+"&per_page=1&page=1&format=json&nojsoncallback=1";
            console.log(url2);
            let urls2 = "";
